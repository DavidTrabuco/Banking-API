...
namespace BankingApi.Infrastructure.Migrations
{
    ...
    [Migration("20260904115854_RemoverNomeUsuario")]
    partial class RemoverNomeUsuario
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankingApi.Domain.Models.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BankingApi.Domain.Models.Usuario", b =>
                {
                    b.HasOne("BankingApi.Domain.Models.Cliente", "Cliente")
                        .WithOne("Usuario")
                        .HasForeignKey("BankingApi.Domain.Models.Usuario", "ClienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
